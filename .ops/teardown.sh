...
# Auth Service - Environment Teardown Script
# This script tears down the auth-service for any environment

set -e  # Exit on any error

# Environment is development (simplified approach)
...
show_help() {
    ...
    echo ""
    echo "This script tears down the auth service development environment."
    echo "Uses Docker Compose for container management."
}
